...
df = pd.read_csv(root_path + '/Data/OpenStack/OpenStack.log_structured.csv', sep=',')
df['GroupId'] = df['BlockId']

raw_df = df[["LineId","BlockId","GroupId", "EventTemplate"]] 
print(raw_df.head())
...
with open(root_path + '/Data/Gloves/Results/EmbeddingDict_OpenStack.json', 'r') as fp:
...
import os, shutil
folder = root_path + "/Data/OpenStack/Graph/Raw"
...
##--------------------------------------------
all_event_df = pd.read_csv(root_path + '/Data/OpenStack/anomaly_label.csv', sep=',')
...
num_graphs_to_test = 30
anomaly_perentage = 0.23
draw_code_val = 1
...
for group_name in tqdm(list_group):
    ...
    MyReadGraph,empty_index = read_tu_data(folder = root_path + "/Data/OpenStack/Graph/TempRaw",
                                           prefix = MyDataName,
                                           adj_type = 'ib')
