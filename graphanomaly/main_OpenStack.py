...
import os, shutil
folder = root_path + '/Data/OpenStack/processed'
...
folder = root_path + '/Data/OpenStack/Raw'
for filename in os.listdir(folder):
    file_path = os.path.join(folder, filename)
    try:
        if os.path.isfile(file_path) or os.path.islink(file_path):
...
src_dir = root_path + '/Data/OpenStack/Graph/Raw/'
 
# path to destination directory
dest_dir = root_path + '/Data/OpenStack/Raw/'
...
parser.add_argument('--data', default='OpenStack',
